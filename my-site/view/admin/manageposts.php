	...
	<table>
		...
		<?php foreach($posts as $post): ?>
			<tr>
				...
				<td><a href="<?php echo $this->base->url."/my-site/controller/admin/posts.php?id=".$post['id']."&action=edit"; ?>" class="btn btn-primary">Edit Post</a><a href="<?php echo $this->base->url."/my-site/controller/admin/posts.php?id=".$post['id']."&action=delete"; ?>" class="btn btn-primary">Delete Post</a></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
